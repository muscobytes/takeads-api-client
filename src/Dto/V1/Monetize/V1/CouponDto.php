...
class CouponDto
{
     ...
     * @param string $endDate Date after which the coupon will no longer apply
     * @param string $description Detailed information about the coupon, including usage conditions and limitations
     * @param string $countryCodes List of country codes in ISO 3166-1 alpha-2 format where the coupon operates
     * @param int $categoryId List of merchant category identifiers
