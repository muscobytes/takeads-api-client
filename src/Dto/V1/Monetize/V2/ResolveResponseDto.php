...
class ResolveResponseDto extends ResponseDto
{
     ...
     * @param string $trackingLink Affiliate link to the advertiser's website (RFC 3986). You can update the s (SubID) and url (Deeplink) parameters after the tracking link is generated.
